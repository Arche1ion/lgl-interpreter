...
creates a new dictionary and sets it in the environment using envs_set
    ...
    Syntax in TUL: ["dictionary","new","dict_name"]
...
### class_define():
Makes a new class dictionary. If the new class has a parent it "inherits" all attributes and methods of the parent class. This is done with merging the attribute/methods dictionary of the parent with the newly created attribute/methods dictionary

    Syntax in TUL: ["class","define","class_name",[attributes],[methods],"parent"]
...
After assigning all attributes the new instance is set in the environment
    ...
    Syntax in TUL: ["class", "instantiate", "instance_name", "class_name", [attributes]]
